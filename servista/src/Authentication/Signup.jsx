    ...
    <div className="flex justify-between items-center">
      <div className="md:w-[50vw] w-full flex flex-col items-center">
        <div className=" text-start">
          <h1 className=" text-2xl font-bold">Hi, Welcome to SerVista</h1>
          <span className="text-sm">Signup using:</span>
        </div>
        <div className="flex gap-5 mx-2 mt-5 font-semibold">
          ...
          <button className="py-3 px-8 border rounded-lg flex items-center gap-2 hover:bg-gray-200">
            <FaFacebook onClick={authWithFacebook} size={23} color="blue" />
            Facebook
          </button>
        </div>
